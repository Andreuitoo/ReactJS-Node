          ...
          <ul className="nav me-auto">
            <li style={{marginRight: "20px"}} className="nav-item">
              <Link to='/' className="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto link-body-emphasis text-decoration-none">
                <img src="./../vite.svg" className="bi me-2" width="40" height="32" />
        ...
        <div id="myCarousel" className="carousel slide mb-6" data-bs-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="./../slider/slide1.jpg" className="bd-placeholder-img" width="100%" height="100%" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"></img>
            ...
            <div className="carousel-item">
              <img src="./../slider/slide2.jpg" className="bd-placeholder-img" width="100%" height="100%" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"></img>
              <div className="container">
            ...
            <div className="carousel-item">
              <img src="./../slider/slide3.jpg" className="bd-placeholder-img" width="100%" height="100%" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"></img>
              <div className="container">
